...
List<Message> chats = [
  Message(
    sender: james,
    time: '5:30 PM',
    text: 'Hey, how\'s it going? What did you do today? asdasdasdas asda asdas ',
    isLiked: false,
    unread: true,
  ),
  Message(
...
sender: currentUser,
time: '4:30 PM',
text: 'Just walked my doge. She was super duper cute. The best pupper!! asdas aSDASDFAS SADFSADAS ASDASDASDASDASDASDASDASDASDASDASAFSDFDSAFSDFSDF',
isLiked: false,
unread: true,
),
Message(
